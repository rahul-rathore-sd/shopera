...
import { ShoppingBag, Lock, Mail, User, Eye, EyeOff, Loader2, AlertCircle } from "lucide-react";
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setApiError(
        err.response?.data?.message || "Registration failed. This email may already be in use."
      );
    } finally {
      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
        <div className="text-center">
          ...
          <p className="mt-1.5 text-xs text-slate-500">
            Join Shopera for faster checkouts and exclusive deals
          </p>
        </div>
